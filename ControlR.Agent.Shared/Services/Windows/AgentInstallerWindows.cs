...
internal class AgentInstallerWindows(
  ...
  : AgentInstallerBase(fileSystem, bundleExtractor, fileSystemPathProvider, controlrApi, deviceDataGenerator, settingsProvider, processes, appOptions, logger), IAgentInstaller
{
